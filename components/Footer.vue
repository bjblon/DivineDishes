<template>
    <div>
        <footer>
    <div class="dark:bg-slate-900 py-4 text-gray-400">
      <div class="container px-4 mx-auto pl-20">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class="block w-56 mb-10">
              ...
              <!-- <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">TheMealDB</tspan>
                    </text> -->
                    <div>
              <h2 class="inline-block text-2xl pb-4  border-b-4 border-blue-600">DivineDishes</h2>
            </div>
            </a>
            <p class="text-justify">
              Remember to always follow proper food safety guidelines when preparing and cooking recipes. Ensure that your ingredients are fresh and of good quality. Adjust seasonings and cooking times according to your taste and preferences.
            </p>
          </div>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">Exploring Global Flavors: Authentic Recipes from Around the World</a></li>
              <li><a href="#" class="hover:text-blue-400">Seasonal Delights: Fresh and Flavorful Recipes for Each Season</a></li>
              <li><a href="#" class="hover:text-blue-400">Sweet Treats Made Easy: Irresistible Dessert Recipes for Every Occasion</a></li>
              <li><a href="#" class="hover:text-blue-400">Food Categories</a></li>
