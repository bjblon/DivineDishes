<template>
  <div>
    <!-- component -->
    <nav class="nav flex flex-wrap items-center justify-center px-5 py-3 dark:bg-slate-900">
  <div class="flex flex-no-shrink items-center mr-6 py-3 text-grey-darkest">
    ...
    <span class="font-semibold text-xl tracking-tight dark:text-white">DivineDishes</span>
  </div>
  ...
  <ul class="menu border-b md:border-none flex justify-end list-reset m-0 w-full md:w-auto">
    <li class="border-t md:border-none">
      ...
      <NuxtLink class="block md:inline-block px-4 py-3 no-underline dark:text-white hover:text-grey-darker font-bold" to ="/">Home</NuxtLink>
    </li>
    
    <li class="border-t md:border-none">
      <!-- <a href="/about/" class="block md:inline-block px-4 py-3 no-underline text-grey-darkest hover:text-grey-darker">About</a> -->
      <NuxtLink class="block md:inline-block px-4 py-3 no-underline dark:text-white hover:text-grey-darker" to = "/products">Products</NuxtLink>
    </li>
    
    <li class="border-t md:border-none">
      <!-- <a href="/blog/" class="block md:inline-block px-4 py-3 no-underline text-grey-darkest hover:text-grey-darker">Blog</a> -->
      <NuxtLink class="block md:inline-block px-4 py-3 no-underline dark:text-white hover:text-grey-darker" to = "/products/alphabet">AlphabeticalOrder</NuxtLink>
